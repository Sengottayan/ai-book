...
const Books = () => {
    ...
    <div className="space-y-6">
      ...
      <div>
        <label className="flex items-center gap-3 cursor-pointer">
          ...
          />
          <span className="text-sm font-medium">Bestsellers Only</span>
        </label>
      </div>
  ...
  return (
    <>
      <Helmet>
        <title>Browse Books | BookHaven - Your Online Book Store</title>
        <meta
          name="description"
          content="Browse our extensive collection of books. Filter by category, price, and more. Find your perfect read at BookHaven."
        />
      </Helmet>
      <Layout>
        <div className="bg-secondary/30 py-8 border-b border-border">
          <div className="container mx-auto px-4">
            ...
            <p className="text-muted-foreground">
              Discover from our collection of {books.length}+ books
            </p>
          </div>
        </div>
