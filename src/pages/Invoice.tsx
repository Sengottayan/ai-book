            ...
            <div className="bg-white min-h-screen p-8 max-w-4xl mx-auto text-black print:p-0">
                ...
                <div className="border border-gray-200 p-8 rounded-sm print:border-none print:p-0">
                    ...
                    <div className="flex justify-between items-start border-b border-gray-200 pb-8 mb-8">
                        <div>
                            <h1 className="text-3xl font-bold font-serif mb-2">BookHaven</h1>
                    ...
                    <div className="mt-12 pt-8 border-t border-gray-200 text-center text-gray-500 text-sm">
                        ...
                        <p className="mt-2">If you have any questions about this invoice, please contact support@bookhaven.com</p>
                    </div>
                </div>
            </div>
        </>
