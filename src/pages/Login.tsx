...
const Login = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{`${isLogin ? (isAdminLogin ? 'Admin Sign In' : 'Sign In') : 'Create Account'} | BookHaven`}</title>
      </Helmet>
          ...
          >
            ...
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">
                {isLogin
                  ? (isAdminLogin ? 'Sign in to manage the BookHaven platform' : 'Sign in to access your account and continue shopping')
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="email"
                    type="email"
                    placeholder={isAdminLogin ? "admin@bookhaven.com" : "you@example.com"}
                    value={email}
            ...
            {!isAdminLogin && (
              <>
                ...
                <div className="grid grid-cols-1 gap-4">
                  <Button variant="outline" className="gap-2" onClick={handleGoogleAutofill}>
