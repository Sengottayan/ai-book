            ...
            <div className="container mx-auto px-4 py-12 max-w-3xl">
                ...
                <Accordion type="single" collapsible className="w-full">
                    ...
                    <AccordionItem value="item-5">
                        ...
                        <AccordionContent>
                            All books sold on BookHaven are brand new, directly from publishers and authorized distributors, unless explicitly marked as "Used" or "Refurbished".
                        </AccordionContent>
                    </AccordionItem>
                </Accordion>
            </div>
