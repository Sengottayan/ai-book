  ...
  const features = [
    {
      ...
      description: 'Ask for books like you would ask a friend',
    },
    {
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: 'Find great reads within your price range',
    },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-paper mb-6">
              Meet Your Personal{' '}
              <span className="text-gradient-gold">Book Assistant</span>
            </h2>

            <p className="text-lg text-paper/70 mb-8">
              Our AI chatbot understands your reading preferences and helps you discover 
              books you'll love. Just ask naturally - "Show me thrillers under ₹500" or 
          ...
          >
            <div className="bg-card rounded-2xl shadow-elevated p-6 max-w-md mx-auto">
              ...
              <div className="flex items-center gap-3 mb-6 pb-4 border-b border-border">
                ...
                <div>
                  <h4 className="font-semibold text-foreground">Book Assistant</h4>
              ...
              <div className="space-y-4">
                <div className="flex justify-end">
                  <div className="bg-primary text-primary-foreground rounded-2xl rounded-br-md px-4 py-2 max-w-[80%]">
                    <p className="text-sm">Show me mystery books under ₹400</p>
                  </div>
                </div>
                ...
                <div className="flex justify-start">
                  <div className="bg-secondary text-secondary-foreground rounded-2xl rounded-bl-md px-4 py-3 max-w-[85%]">
                    <p className="text-sm">
                      Great choice! Here are top mystery picks under ₹400:
                    </p>
              ...
              <div className="mt-6 pt-4 border-t border-border">
                <div className="flex items-center gap-2 bg-secondary/50 rounded-lg px-4 py-3">
                  <span className="text-sm text-muted-foreground">Ask about books...</span>
                </div>
              </div>
            </div>
